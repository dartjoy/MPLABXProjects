...
# 77 "main.c"
int pr_arr[180] = { 47,0,47,0,47,0,59,0,47,0,31,0,39*2,0,59,0,39*2,0,47*2,0,35*2,0,31,0,33*2,0,35*2,0,39*2,0,47,0,39,0,35,0,45,0,39,0,47,0,59,0,52,0,31*2,0,39,0,41,0,45,0,49,0,47,0,37*2,0,35*2,0,59,0,35*2,0,59,0,52,0,39,0,41,0,45,0,49,0,47,0,59/2,0,59/2,0,59/2,0,39,0,41,0,45,0,49,0,47,0,37*2,0,35*2,0,59,0,35*2,0,59,0,52,0,49,0,52,0,59,0,39,0,41,0,45,0,49,0,47,0,37*2,0,35*2,0,59,0,35*2,0,59,0,52,0,39,0,41,0,45,0,49,0,47,0,59/2,0,59/2,0,59/2,0,39,0,41,0,45,0,49,0,47,0,37*2,0,35*2,0,59,0,35*2,0,59,0,52,0,49,0,52,0,59,0};
...
void start(){
    ...
    for(int i=0;i<8;i++){
        ...
        while(temp<1000){
            ...
            while(time_count < 3) time_count++;
            time_count = 0;
            while(time_count < 15 && PORTCbits.RC5 == 1) {
                time_count++;
                if(PORTCbits.RC5 == 0){
